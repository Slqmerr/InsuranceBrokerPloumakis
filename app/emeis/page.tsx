    ...
    <main style={{ fontFamily: UBUNTU, background: "#fff", color: "#1a1a1a", width: "100%" }}>
      ...
      <section style={{
        ...
        >
          <motion.p
            variants={fadeUp}
            style={{ color: "rgba(255,255,255,0.65)", fontSize: "13px", marginBottom: "10px", letterSpacing: "0.08em", textTransform: "uppercase" }}
          >
