...
const VALUE_CARDS = [
  {
    ...
    body: "Σε καθοδηγώ από το μηδέν μεχρι την προετοιμασία για την πιστοποίηση διαμεσολαβητή και τις τεχνικές πωλήσεων που δουλεύουν στην πράξη, βασισμένα σε διεθνή προγράμματα (LIMRA / EIAS).",
  },
  {
    icon: Building2,
  ...
  },
  {
    ...
    body: "Μαθαίνεις το σύστημα αμοιβών με προμήθειες και bonus, οδωγόντας σε μια πραγματική πορεία εξέλιξης.",
  },
];
...
const STEPS = [
  {
    icon: UserPlus,
    title: "Γνωριμία",
    body: "Μια πρώτη κουβέντα χωρίς δεσμεύσεις, για να δω αν ταιριάζουμε και να απαντήσω σε κάθε ερώτησή σου.",
  },
  {
    icon: GraduationCap,
    title: "Εκπαίδευση & πιστοποίηση",
    body: "Σε προετοιμάζω για την πιστοποίηση και σου δίνω τα εργαλεία και τη γνώση για να ξεκινήσεις σωστά.",
  },
  {
    icon: Target,
    title: "Πρώτοι πελάτες με υποστήριξη",
    body: "Ξεκινάς με τη δική μου καθοδήγηση δίπλα σου σε κάθε ραντεβού και προσφορά, μέχρι να αποκτήσεις αυτοπεποίθηση.",
  },
  {
    icon: Rocket,
...
const FAQS = [
  {
    ...
    a: "Όχι. Οι περισσότεροι συνεργάτες μου ξεκίνησαν χωρίς εμπειρία στον κλάδο. Σε εκπαιδεύω από την αρχή και σε στηρίζω μέχρι να σταθείς στα πόδια σου.",
  },
  {
    q: "Πληρώνω κάτι για να ξεκινήσω;",
    a: "Δεν υπάρχει κόστος εισόδου. Επενδύεις τον χρόνο και τη διάθεσή σου. Παρέχω την εκπαίδευση, τα εργαλεία και την υποστήριξη.",
  },
  {
    q: "Μπορώ να ξεκινήσω με μερική απασχόληση;",
    a: "Ναι. Πολλοί ξεκινούν ως δεύτερη δραστηριότητα και περνούν σε πλήρη απασχόληση όταν το χαρτοφυλάκιό τους μεγαλώσει. Το προσαρμόζω στον ρυθμό σου.",
  },
  {
    q: "Πώς αμείβομαι;",
    a: "Με προμήθειες επί των συμβολαίων και πρόσθετα bonus παραγωγής. Το σύστημα είναι διαφανές και σου το εξηγώ αναλυτικά από την πρώτη κουβέντα.",
  },
  {
    q: "Χρειάζομαι άδεια ή πιστοποίηση;",
    a: "Ναι, η άσκηση του επαγγέλματος απαιτεί πιστοποίηση διαμεσολαβητή. Σε προετοιμάζω και σε καθοδηγώ σε όλη τη διαδικασία.",
  },
];
  ...
  return (
    <main style={{ fontFamily: UBUNTU, background: "#fff", color: "#1a1a1a", width: "100%" }}>
      ...
      <section className="section-pad" style={{ background: "#fff", padding: "72px 64px" }}>
        ...
        >
          Γιατί να συνεργαστείς μαζί μου
        </motion.h2>
        <motion.p
          variants={fadeUp}
          initial="hidden"
      ...
      <section id="aitisi" style={{ background: "#fff", scrollMarginTop: "96px" }}>
        <div className="band-header" style={{ background: "#a30000", padding: "56px 64px 88px", textAlign: "center" }}>
          ...
          <p className="fade-up" style={{ color: "rgba(255,255,255,0.88)", fontSize: "16px", lineHeight: 1.6, margin: "0 auto", maxWidth: "520px", animationDelay: "0.08s" }}>
            Συμπλήρωσε τα στοιχεία σου και θα επικοινωνήσω μαζί σου για μια πρώτη κουβέντα, χωρίς καμία δέσμευση.
          </p>
        </div>
