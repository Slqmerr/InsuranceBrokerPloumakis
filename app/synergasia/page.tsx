...
const DESCRIPTION =
  "Χτίσε καριέρα στην ασφάλιση δίπλα μας. Εκπαίδευση και προετοιμασία για την πιστοποίηση διαμεσολαβητή, εργαλεία, υποστήριξη στα πρώτα ραντεβού και ξεκάθαρο πλάνο αμοιβών.";
