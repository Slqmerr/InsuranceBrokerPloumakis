...
const FAQS = [
  {
    ...
    a: "Όχι. Οι περισσότεροι συνεργάτες μας ξεκίνησαν χωρίς εμπειρία στον κλάδο. Σε εκπαιδεύουμε από την αρχή και σε στηρίζουμε καθόλη τη διάρκεια της καριέρας σου.",
  },
  {
    ...
    <main style={{ fontFamily: UBUNTU, background: "#fff", color: "#1a1a1a", width: "100%" }}>
      ...
      <section className="emeis-hero" style={{ display: "flex", flexDirection: "row", minHeight: "460px", background: "#a30000", overflow: "hidden" }}>
        ...
        >
          ...
          >
            Χτίσε καριέρα στην ασφάλιση, δίπλα σε έναν μέντορα με 27 χρόνια πορεία
          </motion.h1>
