...
function processSteps(product: Product): { title: string; text: string }[] {
  return [
    {
      title: "Επικοινωνία",
      text: `Με καλείτε ή ζητάτε προσφορά για «${product.title}» online, χωρίς καμία δέσμευση.`,
    },
    {
      title: "Σύγκριση",
      text: `Εξετάζω τα προγράμματα «${product.title}» των συνεργαζόμενων εταιρειών για εσάς.`,
    },
    {
      title: "Απόφαση",
      text: "Επιλέγετε το πρόγραμμα που ταιριάζει σε εσάς — τα υπόλοιπα τα αναλαμβάνω εγώ.",
    },
  ];
}
    ...
    <main style={{ fontFamily: UBUNTU, background: "#fff", color: "#1a1a1a", width: "100%", minHeight: "100vh" }}>
      ...
      <section className="pp-body" style={{
        ...
        {product.variantGroups && (
          <div style={{ margin: "0 0 44px" }}>
            ...
            <p style={{ fontSize: "14px", color: "#777", lineHeight: 1.6, margin: "0 0 24px" }}>
              Επιλέγω μαζί σας ποιες από αυτές χρειάζεται η δραστηριότητά σας — συχνά περισσότερες από μία, σε ένα ενιαίο συμβόλαιο.
            </p>
        ...
        <p style={{ fontSize: "14px", color: "#777", lineHeight: 1.7, margin: 0 }}>
          Συνεργάζομαι με κορυφαίες ασφαλιστικές εταιρείες, ώστε να βρω μαζί σας το πρόγραμμα που ταιριάζει στις ανάγκες σας. Επικοινωνήστε μαζί μου για μια εξατομικευμένη προσφορά.
        </p>
        </div>
