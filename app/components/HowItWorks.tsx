...
const STEPS = [
  {
    num: "01",
    icon: MessageCircle,
    title: "Μιλήστε μαζί μου",
    text: "Μου λέτε τις ανάγκες και τις ανησυχίες σας. Ακούω προσεκτικά και κατανοώ τι θέλετε να προστατέψετε.",
  },
  {
    num: "02",
    icon: Scale,
    title: "Συγκρίνω για εσάς",
    text: "Αναζητώ και συγκρίνω προσφορές από τις συνεργαζόμενες εταιρείες, για να βρω τη σωστή κάλυψη στη σωστή τιμή.",
  },
  {
    num: "03",
    icon: ShieldCheck,
    title: "Σας στηρίζω διαρκώς",
    text: "Αναλαμβάνω τα πάντα. Από τη σύναψη του συμβολαίου μέχρι την υποστήριξη σε κάθε αποζημίωση.",
  },
];
