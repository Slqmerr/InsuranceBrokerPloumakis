...
export const PROFILES: Record<string, QuoteProfile> = {
  ...
  LIABILITY: {
    fields: [
      ...
      {
        name: "liabilityType",
        label: "Τύπος αστικής ευθύνης",
        type: "select",
        options: [
          "Γενική αστική ευθύνη (λειτουργία / χώρος)",
          "Αστική ευθύνη εργοδότη",
          "Αστική ευθύνη προϊόντος",
          "Επαγγελματική αστική ευθύνη (E&O)",
      ...
      {
        name: "coverageLimit",
        label: "Επιθυμητό όριο κάλυψης",
        type: "select",
        options: ["100.000€", "300.000€", "500.000€", "1.000.000€", "Άνω του 1.000.000€", "Να μου προταθεί"],
      },
    ],
  },
  // Professional indemnity — the differentiator is the profession, not the site
  PROFESSIONAL_LIABILITY: {
    fields: [
      { name: "profession", label: "Επάγγελμα / ειδικότητα", type: "text", required: true },
      { name: "services", label: "Υπηρεσίες που παρέχετε", type: "text" },
      { name: "employees", label: "Αριθμός εργαζομένων / συνεργατών", type: "number" },
      {
        name: "turnover",
        label: "Ετήσιος κύκλος εργασιών",
        type: "select",
        options: ["Έως 100.000€", "100.000€ – 500.000€", "500.000€ – 1.000.000€", "Άνω του 1.000.000€"],
      },
      {
        name: "requirement",
        label: "Απαιτείται η ασφάλιση από τον νόμο, από πελάτη ή από διαγωνισμό;",
        type: "select",
        options: ["Ναι, από τον νόμο", "Ναι, από πελάτη / διαγωνισμό", "Όχι", "Δεν γνωρίζω"],
      },
      {
        name: "coverageLimit",
        label: "Επιθυμητό όριο κάλυψης",
      ...
      {
        name: "priorClaims",
        label: "Υπάρχουν προηγούμενες αξιώσεις ή γνωστές εκκρεμότητες;",
        type: "select",
        options: ["Όχι", "Ναι", "Δεν γνωρίζω"],
      },
    ],
  },
  CYBER: {
...
export const SLUG_TO_PROFILE: Record<string, keyof typeof PROFILES> = {
  ...
  "astiki-efthyni-ergodoti": "LIABILITY",
  "astiki-efthyni-proiontos": "LIABILITY",
  "astiki-efthyni-touristikon": "LIABILITY",
  "epaggelmatiki-astiki-efthyni": "PROFESSIONAL_LIABILITY",
  oxima: "AUTO",
